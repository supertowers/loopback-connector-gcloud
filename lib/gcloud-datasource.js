...
GcloudDataSourceConnector.prototype.getDataSet = function() {
    return this._dataSet;
};

GcloudDataSourceConnector.prototype.getDataSetKey = function(model, entityId) {
    return entityId ? this._dataSet.key([model, entityId]) : this._dataSet.key(model);
};

GcloudDataSourceConnector.prototype.getCorrectProperties = function(model, data) {
...
GcloudDataSourceConnector.prototype.connect = function(callback) {
    callback && callback();
};

GcloudDataSourceConnector.prototype.disconnect = function(callback) {
    callback && callback();
};

GcloudDataSourceConnector.prototype.all = function(model, filter, callback) {
    debug('all: model', model);
    debug('all: filter', filter);
    this.find(model, filter, callback);
};

GcloudDataSourceConnector.prototype.find = function(model, filter, callback) {
...
GcloudDataSourceConnector.prototype.findById = function(model, id, callback) {
...
GcloudDataSourceConnector.prototype.create = function(model, data, options, callback) {
...
GcloudDataSourceConnector.prototype.updateAttributes = function(model, id, data, options, callback) {
    assert(id, 'Entity ID missing');
 ...
 * @param {Function} callback The callback function
 */
GcloudDataSourceConnector.prototype.destroyAll = function(model, where, options, callback) {
 ...
 */
GcloudDataSourceConnector.prototype.count = function(model, where, options, callback) {
